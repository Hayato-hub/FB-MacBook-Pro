...
<html>
    ...
    <body>
        <div class="big-body">
            ...
            <div class="center">
                <a href="https://www.gamefeat.net/webapi/v1/reportClick?ad_id=8126&site_id=27669" target="_blank" class="btn-square-shadow dl_top"><i class="fab fa-apple"></i> 公式AppleStoreはコチラ <i class="fas fa-arrow-circle-right"></i></a>
            ...
            <div class="line"></div>
            <div class="center">
                <img src="{{ asset('image/adult_55.PNG') }}" class="small"></img>
            </div>
            <img src="{{ asset('image/adult_44.JPG') }}"></img>
            <img src="{{ asset('image/adult_66.JPG') }}"></img>
            <br>
            <div class="center">
                <h1>そして、動画投稿も熱い!!! <i class="far fa-hand-point-down"></i></h1>
                <img src="{{ asset('image/adult_88.JPG') }}" class="small"></img>
            </div>
            <div class="center">
            ...
            <div class="center">
                <a href="https://www.gamefeat.net/webapi/v1/reportClick?ad_id=8126&site_id=27669" target="_blank" class="btn-square-shadow dl"><i class="fab fa-apple"></i> 公式AppleStoreはコチラ <i class="fas fa-arrow-circle-right"></i></a>
        ...
        <div class="footer">
            <img src="{{ asset('image/noRank_footer.jpg') }}"></img>
            <p>LEMON.inc @2020/07</p>
        </div>
    </body>
</html>